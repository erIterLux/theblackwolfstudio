...
export const memberships = [
    {
        ...
        price: '$49',
        cadence: 'per year',
        description: 'The core digital tools for building and tracking a consistent practice.',
        features: [
    ...
    },
    {
        ...
        price: '$199',
        cadence: 'per year',
        description: 'Progression, training references, and guided support between sessions.',
        features: [
            'Studio progression system',
            'Member training library',
    ...
    },
    {
        ...
        price: '$299',
        cadence: 'per year',
        description: 'The complete digital practice system with one included private lesson.',
        features: [
            'Studio progression system',
            'Member training library',
