...
export default function NotificationsPage() {
  ...
  const [preferenceStatus, setPreferenceStatus] = useState({ loading: true, saving: false, message: '' });
  ...
  const openNotification = async (item) => {
    try {
      if (item.status === 'unread') await setRead(item.id, true);
    } catch (readError) {
      ...
      <div className="container">
        <header className="notification-page__header">
          ...
          <div className="notification-page__header-actions">
            ...
            <button className="button" type="button" onClick={markAllRead} disabled={!unreadCount}>
        ...
        <div className="notification-layout">
          <main className="notification-panel">
            ...
            {error && <div className="notification-message notification-message--error">{error}</div>}
            ...
            {!loading && !error && visible.length === 0 && (
              <div className="notification-empty">
                ...
                <p>New updates will appear here as studio activity occurs.</p>
              </div>
            )}
                      ...
                      <div className="notification-item__body">
                        ...
                        <div className="notification-item__actions">
                          ...
                          <button
                            ...
                            type="button"
                            onClick={() => setRead(item.id, item.status !== 'read')}
                          >
