    ...
    <>
      <section className="hero">
        ...
        <div className="container hero__grid">
          ...
          <div className="hero__visual" aria-label="The Black Wolf Studio identity">
            <div className="hero__ring hero__ring--one" />
            <div className="hero__ring hero__ring--two" />
            <div className="hero__logo-field">
              <img src="/images/black-wolf-mark.png" alt="The Black Wolf Studio wolf and sheep emblem" />
            </div>
            <div className="hero__tag hero__tag--top">Awareness</div>
            <div className="hero__tag hero__tag--left">Choice</div>
            <div className="hero__tag hero__tag--right">Capacity</div>
          </div>
        </div>
