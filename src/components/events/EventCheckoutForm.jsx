    ...
    <form className="event-checkout" onSubmit={beginCheckout}>
      ...
      <div className="event-registration-explainer">
        ...
        <div>
          ...
          <p>
            Payment reserves each person&apos;s place. Every participant will then
            complete this event&apos;s waiver before checking in separately at the event.
          </p>
        </div>
      </div>
      ...
      <section className="event-checkout__section event-checkout__pricing">
        <div className="event-checkout__section-heading">
          ...
          <div>
            ...
            <p>Signed-in member pricing is applied automatically when eligible.</p>
          </div>
        </div>
      ...
      <div className="event-waiver-preview">
        ...
        <p>
          This payment completes registration only. A separate event waiver is
          required for every participant before event check-in.
        </p>
      </div>
      ...
      <div className="event-checkout__actions">
        <button className="button" type="submit" disabled={busy || quoteLoading || !quote}>
          ...
          {busy ? 'Opening secure checkout…' : 'Register and continue to payment'}
        </button>
      </div>
    </form>
  );
