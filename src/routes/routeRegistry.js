const routeDefinitions = {
  ...
  privateTrainingDetail: () => import('../pages/PrivateTrainingDetailPage'),
  privateTrainingSuccess: () => import('../pages/PrivateTrainingSuccessPage'),
  events: () => import('../pages/EventsPage'),
  eventDetail: () => import('../pages/EventDetailPage'),
  eventRegistration: () => import('../pages/EventRegistrationPage'),
  eventSuccess: () => import('../pages/EventSuccessPage'),
  eventWaiver: () => import('../pages/EventWaiverPage'),
  privateTrainingWaiver: () => import('../pages/PrivateTrainingWaiverPage'),
  memberWaiver: () => import('../pages/MemberWaiverPage'),
  ...
  instructorQrCode: () => import('../pages/InstructorQrCodePage'),
  ...
  instructorInquiries: () => import('../pages/InstructorInquiriesPage'),
...
const routeMatchers = [
  ...
  [/^\/events\/[^/]+\/register\/?$/, 'eventRegistration'],
  [/^\/events\/[^/]+\/?$/, 'eventDetail'],
  [/^\/private-training\/waiver\/[^/]+\/?$/, 'privateTrainingWaiver'],
  [/^\/membership\/?$/, 'membership'],
  [/^\/private-training\/?$/, 'privateTraining'],
  [/^\/private-training\/success\/?$/, 'privateTrainingSuccess'],
  [/^\/private-training\/[^/]+\/?$/, 'privateTrainingDetail'],
  [/^\/order\/[^/]+\/?$/, 'orderDetails'],
  [/^\/contact\/?$/, 'contact'],
  [/^\/login\/?$/, 'login'],
  ...
  [/^\/instructor\/inquiries\/?$/, 'instructorInquiries'],
  ...
  [/^\/instructor\/qr-code\/?$/, 'instructorQrCode'],
